...
2. **Сообщите об идее через создание нового `Issue` в проекте.**
...
репозитории. Хорошие отчеты об ошибках чрезвычайно полезны - спасибо!
...
получить обратную связь профессиональных разработчиков, составить своё портфолио открытых работ.
Они должны оставаться сфокусированными по объему на одной проблеме и избегать несвязанных
изменений.

1. Сделайте коммит с вашими изменениями, используя в названии коммита ссылку на решаемую проблему по шаблону: 
